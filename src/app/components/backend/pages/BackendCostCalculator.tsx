  ...
  return (
    <div className="space-y-5">
          ...
          {steps.map(s => {
            ...
            return (
              <button
                ...
                className={`flex-1 flex items-center justify-center gap-2 py-2.5 rounded-[8px] text-sm font-medium transition-all ${
                  ...
                  <div className="flex flex-wrap gap-2">
                    {VOLUME_BANDS.map(band => (
                      <button
                        ...
                        className={`px-3 py-1.5 rounded-[8px] text-xs font-medium font-mono transition-all ${
                          volumeBand === band.key
                            ? 'bg-brand text-white'
              ...
              <div className="space-y-5">
                      ...
                      return (
                        <button
                          ...
                          className={`w-full flex items-center gap-3 px-4 py-3 rounded-[8px] border transition-all text-left ${
                            active ? 'border-brand bg-brand-50/30' : 'border-gray-200 bg-white hover:bg-gray-50'
                          }`}
                        >
                ...
                {merchantType && (
                  <div className="bg-white border border-gray-200 rounded-[8px] p-4">
                    ...
                    {cdScore < 50 && (
                      <p className="text-[11px] text-gray-500 mt-2 p-2 bg-red-50 rounded-[8px] leading-relaxed">
                  ...
                  <div className="flex gap-3">
                    <div className="flex-1">
                      ...
                      <input type="number" value={avgTicket} onChange={e => setAvgTicket(e.target.value)}
                        ...
                        className="w-full px-2.5 py-2 bg-white border border-gray-200 rounded-[8px] text-sm font-mono text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-brand/20 focus:border-brand"
                      />
                    </div>
                    <div className="flex-1">
          ...
          <div className="space-y-5">
            ...
            <div className="grid grid-cols-2 gap-3">
              <button
                ...
                className={`relative flex items-center gap-3 p-4 rounded-[8px] border text-left transition-all ${
                  isCashDiscount ? 'border-brand bg-brand-50/30' : 'border-gray-200 bg-white hover:bg-gray-50'
                }`}
              >
                ...
                {isCashDiscount && (
                  <span className="absolute top-2 right-2.5 text-[9px] font-bold tracking-wide text-brand bg-brand-100 px-2 py-0.5 rounded">RECOMMENDED</span>
                )}
              </button>
              <button
            ...
            <div className="grid grid-cols-1 lg:grid-cols-[1fr_280px] gap-5">
              ...
              <div className="space-y-4">
                <div className="bg-white border border-gray-200 rounded-[8px] p-6 text-center">
                  ...
                  {isCashDiscount && cdPricing && cdPricing.monthlyFee > 0 && (
                    <p className="inline-block mt-4 text-xs font-mono text-gray-500 bg-gray-100 px-3 py-1 rounded-[8px]">${cdPricing.monthlyFee}/mo program fee</p>
                  )}
              ...
              <div className="bg-gray-50 border border-gray-200 rounded-[8px] p-4 space-y-3 h-fit">
                ...
                {cdAnnual && frAnnual && (
                  <div className="bg-brand-50 rounded-[8px] p-3 mt-2">
        ...
        {step === 3 && strategy && (
          <div className="space-y-5">
            {/* Header */}
            <div className="flex items-start justify-between bg-brand-50/50 border border-brand-100 rounded-[8px] p-5">
              <div>
              ...
              <span className="text-[11px] font-semibold text-brand bg-brand-100 px-3 py-1.5 rounded-[8px] whitespace-nowrap">
            ...
            <div>
              <div className="flex items-center gap-2.5 mb-3">
                <span className="w-6 h-6 rounded-full bg-brand-100 text-brand flex items-center justify-center text-xs font-bold font-mono">1</span>
            ...
            {strategy.keyObjections.length > 0 && (
              <div>
                <div className="flex items-center gap-2.5 mb-3">
                  <span className="w-6 h-6 rounded-full bg-brand-100 text-brand flex items-center justify-center text-xs font-bold font-mono">2</span>
                        ...
                        {isOpen && (
                          <div className="px-4 pb-4 space-y-3 bg-white">
                            ...
                            <div>
                              ...
                              <div className="text-sm text-gray-700 leading-relaxed p-3 bg-brand-50/50 rounded-[8px] border-l-3 border-brand" style={{ borderLeft: '3px solid #4318FF' }}>
                                {obj.talk}
                              </div>
                            </div>
                      ...
                      <div key={objKey} className={`border rounded-[8px] overflow-hidden opacity-60 transition-colors ${isOpen ? 'border-brand/15 opacity-100' : 'border-gray-100'}`}>
                        ...
                        {isOpen && (
                          <div className="px-4 pb-4 space-y-3 bg-white">
                            ...
                            <div>
                              <p className="text-[10px] font-semibold text-gray-500 uppercase tracking-wide mb-1.5">What to say:</p>
                              <div className="text-sm text-gray-700 leading-relaxed p-3 bg-brand-50/50 rounded-[8px]" style={{ borderLeft: '3px solid #4318FF' }}>
                                {obj.talk}
                              </div>
                            </div>
                            <div className="flex items-start gap-2 text-xs text-gray-500 leading-relaxed">
