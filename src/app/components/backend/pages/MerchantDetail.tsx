        ...
        <div className="px-6 py-6">
          ...
          <div className="flex items-start justify-between">
            ...
            <div className="flex items-center gap-3">
              ...
              <button onClick={() => navigate('/underwriting')} className="delt-btn-primary flex items-center gap-2"><Plus className="w-4 h-4" />New MCA Application</button>
            </div>
          </div>
        </div>
      </div>
        ...
        {activeTab === 'outreach' && (
          <div className="space-y-6">
            ...
            <div className="bg-gradient-to-r from-indigo-50 to-purple-50 rounded-lg border border-indigo-200 px-5 py-4 flex items-center justify-between">
              ...
              <button onClick={() => navigate('/outreach')} className="delt-btn-primary shrink-0"><Send className="w-3.5 h-3.5" />Go to Outreach</button>
            </div>
              ...
              <>
                ...
                <div className="bg-white rounded-lg border border-gray-200">
                  ...
                  <div className="px-5 py-4">
                    ...
                    <div className="flex items-center gap-3"><a href="#" className="delt-btn-secondary"><Edit className="w-4 h-4" />Edit Website</a><a href="https://www.sunrisecafe.com" target="_blank" rel="noopener noreferrer" className="delt-btn-secondary"><ExternalLink className="w-4 h-4" />View Live Site</a></div>
                  </div>
                </div>
        ...
        {activeTab === 'lens' && (
          <div className="space-y-6">
            {merchantProducts.lens === 'inactive' ? (
              <div className="bg-white rounded-lg border border-gray-200"><div className="py-16 flex flex-col items-center justify-center text-center px-6"><div className="w-14 h-14 rounded-2xl bg-purple-50 flex items-center justify-center mb-4"><Brain className="w-7 h-7 text-purple-400" /></div><h3 className="text-lg font-semibold text-gray-900 mb-1">Lens AI Not Active</h3><p className="text-sm text-gray-500 mb-5 max-w-sm">Activate to unlock AI-powered insights.</p><button onClick={() => navigate('/lens')} className="delt-btn-primary">Activate Lens AI</button></div></div>
            ) : (
              <>
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                  <div className="delt-card p-4"><div className="flex items-center justify-between mb-2"><span className="text-xs text-gray-500 font-medium">API Calls (MTD)</span><Zap className="w-4 h-4 text-purple-500" /></div><p className="text-xl font-bold text-gray-900">12,847</p><p className="text-xs text-emerald-600 mt-1">+18.3% vs last month</p></div>
                  <div className="delt-card p-4"><div className="flex items-center justify-between mb-2"><span className="text-xs text-gray-500 font-medium">Avg Response Time</span><Activity className="w-4 h-4 text-blue-500" /></div><p className="text-xl font-bold text-gray-900">142ms</p><p className="text-xs text-emerald-600 mt-1">-12ms from last month</p></div>
                  <div className="delt-card p-4"><div className="flex items-center justify-between mb-2"><span className="text-xs text-gray-500 font-medium">Success Rate</span><Shield className="w-4 h-4 text-emerald-500" /></div><p className="text-xl font-bold text-gray-900">99.7%</p><p className="text-xs text-gray-400 mt-1">3 failed in last 30 days</p></div>
                  <div className="delt-card p-4"><div className="flex items-center justify-between mb-2"><span className="text-xs text-gray-500 font-medium">Monthly Cost</span><BarChart3 className="w-4 h-4 text-amber-500" /></div><p className="text-xl font-bold text-gray-900">$64.24</p><p className="text-xs text-amber-600 mt-1">$0.005/call avg</p></div>
                </div>
                <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
                  <div className="lg:col-span-3 space-y-6">
                    <div className="bg-white rounded-lg border border-gray-200">
